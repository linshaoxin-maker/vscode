...
import { ChipOSWorkspaceMcpDiscoveryAdapter } from '../common/discovery/workspaceMcpDiscoveryAdapter.js';
...
mcpDiscoveryRegistry.register(new SyncDescriptor(ChipOSWorkspaceMcpDiscoveryAdapter));
