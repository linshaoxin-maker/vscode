	...
	registerAction2(class ShowExtensionsUsingCopilot extends Action2 {
		...
		constructor() {
			super({
				...
				title: localize2('showCopilotUsageExtensions', "Show AI Extensions"),
				f1: true,
	...
	registerAction2(class ShowQuotaExceededDialogAction extends Action2 {
		...
		constructor() {
			super({
				...
				title: localize('upgradeChat', "Upgrade Plan")
			});
		}
		...
		override async run(accessor: ServicesAccessor) {
			...
			const upgradeToPro = free ? localize('upgradeToPro', "Upgrade to Pro for:\n- Unlimited inline suggestions\n- Unlimited chat messages\n- Access to premium models") : undefined;

			await dialogService.prompt({
				type: 'none',
				message: localize('copilotQuotaReached', "AI Quota Reached"),
				cancelButton: {
				...
				buttons: [
					{
						label: free ? localize('upgradePro', "Upgrade to Pro") : localize('upgradePlan', "Upgrade Plan"),
						run: () => {
