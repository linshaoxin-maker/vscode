...
export interface IEventStreamClient extends IDisposable {
	...
	disconnect(): void;
	sendTask(sessionId: string, query: string, mentions: IMentionItem[], mode: 'agent' | 'spec', options: { thinking: boolean; autoApproveMode: string; llmConfig?: { provider: string; api_key: string; base_url: string; model: string } }): void;
...
export class MockEventStreamClient extends Disposable implements IEventStreamClient {
	...
	sendTask(sessionId: string, query: string, _mentions: IMentionItem[], _mode: 'agent' | 'spec', _options: { thinking: boolean; autoApproveMode: string; llmConfig?: { provider: string; api_key: string; base_url: string; model: string } }): void {
