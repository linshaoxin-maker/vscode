...
export type ChipOSSettingsTab = 'general' | 'organization' | 'models' | 'features' | 'connection' | 'rules' | 'commands' | 'skills' | 'hooks' | 'agents' | 'plugins' | 'beta' | 'tools' | 'edaTools' | 'edaDoctor';
